 ...
 *
 * Consumes domain commands, delegates HTTP work to {@link ResourceApi},
 * and exposes reactive signals to the presentation layer.
 */
...
export class ResourceStore {
  ...
  loadBranches(accountId = this.accountId() || this.authService.currentUser()?.accountId || ''): void {
    this.resourceApi
